      ...
      <section className="bg-warm-white pt-14 pb-10 sm:pt-20 sm:pb-14">
        <div className="mx-auto max-w-7xl px-6 sm:px-10 lg:px-14">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_320px] lg:items-center lg:gap-20 xl:grid-cols-[1fr_360px]">
            ...
            {/* Retrato — double-bezel architecture */}
            <div
              data-reveal data-reveal-delay="0.18"
              className="max-h-[480px] p-2 ring-1 ring-navy/[0.06] lg:max-h-none"
              style={{ aspectRatio: '3/4' }}
            >
              <div className="relative h-full w-full overflow-hidden shadow-[inset_0_1px_1px_rgba(255,255,255,0.6)]">
                <Image
            ...
            >
              ...
              <div className="flex flex-col">
                <ul className="flex flex-col" role="list">
                  {credentialGroups.flatMap(group => group.items).map((item, i) => (
                    <li key={i} className="border-t border-navy/[0.08] py-3.5 font-body text-[0.825rem] leading-snug text-navy/70">
                      {item}
                    </li>
                  ))}
                </ul>
