      ...
      <section className="bg-white pt-14 sm:pt-20">
        <div className="mx-auto max-w-7xl px-6 sm:px-10 lg:px-14">
          ...
          <div className="mb-7 flex flex-col gap-3 sm:mb-8">
            ...
            <p data-reveal data-reveal-delay="0.09" className="mt-1 max-w-[52ch] font-body text-[1rem] leading-[1.85] text-navy/70">
              {tContacto('subtitle')}
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              <p className="font-body text-[0.875rem] leading-relaxed text-navy/70">
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-10 lg:px-14">
          <div className="grid grid-cols-1 gap-14 lg:grid-cols-[1fr_1fr] lg:gap-24">
            ...
            <div className="flex flex-col">
              ...
              <p data-reveal data-reveal-delay="0.19" className="mt-5 max-w-[42ch] font-body text-[0.875rem] leading-[1.85] text-navy/65">
          ...
          <div className="grid grid-cols-1 border-t border-navy/[0.08] divide-y divide-navy/[0.08] sm:grid-cols-2 sm:divide-y-0 sm:divide-x lg:grid-cols-4">
            ...
            <div className="flex flex-col gap-4 px-7 py-7 sm:px-8 sm:py-9 sm:border-b sm:border-b-navy/[0.08] lg:border-b-0">
              ...
              {CLINIC_HOURS ? (
                ...
                <p className="font-body text-[0.9375rem] leading-relaxed italic text-navy/60">
            ...
            <div className="flex flex-col gap-4 px-7 py-7 sm:px-8 sm:py-9 sm:border-b sm:border-b-navy/[0.08] lg:border-b-0">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-2 font-body text-[0.7rem] font-semibold uppercase tracking-[0.2em] text-navy/50 transition-colors duration-150 [@media(hover:hover)_and_(pointer:fine)]:hover:text-blue focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue"
              >
                Cómo llegar →
              </a>
            </div>
