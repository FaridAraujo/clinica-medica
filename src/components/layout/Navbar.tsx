  ...
  return (
    <>
                  ...
                  <Link
                    ...
                    className={[
                      ...
                      dark
                        ...
                        : active
                          ? 'text-navy'
                          : 'text-navy/60 [@media(hover:hover)_and_(pointer:fine)]:hover:text-navy',
                    ].join(' ')}
                  >
                    {label}
                    <span
      ...
      <div
        ...
        aria-hidden={!open}
        className={[
          'fixed bottom-0 right-0 top-0 z-50 flex w-[min(88vw,340px)] flex-col bg-warm-white lg:hidden',
      ...
      >
        ...
        <div className="flex h-16 shrink-0 items-center justify-between border-b border-navy/[0.08] px-6">
          <Link
            ...
            tabIndex={open ? 0 : -1}
            style={{ touchAction: 'manipulation' }}
            className="inline-flex items-center gap-2 font-body text-[0.8rem] font-medium text-navy/60 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue [@media(hover:hover)_and_(pointer:fine)]:hover:text-navy"
          >
          ...
          <button
            ...
            style={{ touchAction: 'manipulation' }}
            className="flex h-9 w-9 items-center justify-center text-navy/50 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue [@media(hover:hover)_and_(pointer:fine)]:hover:text-navy"
          >
